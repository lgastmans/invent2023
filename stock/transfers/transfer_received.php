...
/**
* 
* @version 	$Id: transfer_received.php,v 1.3 2006/02/22 10:16:19 cvs Exp $
...
$grid = new DBGrid('stock_received');
...
$grid->addColumn("Batch", "sb.batch_code", "string", true,50); 
...
$grid->setSubmitURL('transfer_received.php');

$grid->addUniqueFilter('ssb.storeroom_id_to','equals',$_SESSION['int_current_storeroom'],'number');
...
$grid->str_image_path='../../images/';
	if (($_SESSION["int_month_loaded"] == date('n')) && ($_SESSION["int_year_loaded"] == date('Y'))) {
		if ($int_access_level > ACCESS_READ) {
			...
			$grid_form->addButton('direct receive', '../../images/lightning_add.png', 'directReceive', 'left');
			$grid_form->addHTML('&nbsp;', 'left');
