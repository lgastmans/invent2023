...
/*			.ff th.yui-dt-hidden,
		...
		<script language="javascript">
			/*
				CUSTOM FIELDS
			*/
			var SQL = "SELECT sp.product_id, sp.product_code, sp.product_description, sb.batch_code, sb.date_created, sb.selling_price, "+
				"mu.measurement_unit, ssb.storeroom_id_from, ssb.storeroom_id_to, ssb.transfer_type, ssb.transfer_quantity, "+
				"ssb.transfer_description, ssb.transfer_reference, ssb.transfer_id, ssb.transfer_status, s2.description, "+
				"st.transfer_type_description, ssb.date_created, sup.supplier_name, u.username, mu.is_decimal, sc.category_description "+
				...
				"LEFT JOIN stock_storeroom s2 ON (s2.storeroom_id = ssb.storeroom_id_to) "+
				"LEFT JOIN stock_supplier sup ON (sup.supplier_id = sb.supplier_id) "+
				"INNER JOIN user u ON (u.user_id = ssb.user_id)";
			var ID = "transfer_id";
			var uniqueFilter = "ssb.storeroom_id_from = <?php echo $_SESSION['int_current_storeroom']?>";
