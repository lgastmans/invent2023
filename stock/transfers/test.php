...
/**
* 
* @version 	$Id: test.php,v 1.2 2006/02/25 06:29:23 cvs Exp $
...
$grid->addColumn(" ID", "sp.product_id", "custom", false, 20,"drawDir"); 
$grid->addColumn("Instructor Name", "u.username", "string", true,150); 
//$grid->addColumn("Batch Code", "sb.batch_code", "string", true,100); 
$grid->addColumn("Join Date", "ssb.date_created", "date", true,60); 
$grid->addColumn("Address", "s1.description", "string", true,200); 
$grid->addColumn("County", "s1.description", "string", true); 
$grid->addColumn("Courses", "s2.description", "string", true); 
$grid->addColumn("Department", "ssb.transfer_description", "string", true); 
...
$grid_form->addButton('Dispatch Selected Request','../../images/new.gif','dispatchTransfer()','left');
$grid_form->addButton('Dispatch Selected Request','../../images/modify.gif','dispatchTransfer()','left');
$grid_form->addButton('Dispatch Selected Request','../../images/delete.gif','dispatchTransfer()','left');
