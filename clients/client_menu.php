<?
	...
	$str_grid_name = "admin_customer";
	
	insert_grid_fields('customer', $str_grid_name, $_SESSION['int_user_id']);
...
<head>
	...
	<script language="javascript">
		...
		function editNews() {
			...
			if (ID > 0) {
				myWin = window.open("viewcustomer.php?id=" + ID, 'newsedit', 'width=600,height=650,resizable=yes');
		...
		function addNews() {
			myWin = window.open("viewcustomer.php", 'newsedit', 'width=600,height=650,resizable=yes');
			myWin.moveTo((screen.availWidth/2 - 600/2), (screen.availHeight/2 - 650/2));
			myWin.focus();
		}
		...
		function printStatement(strGridName) {
			...
			var strURL = "client_grid_print.php?"+
				"grid_name="+strGridName+
				"&filter="+oTextFilter.value+
				"&field="+oSelectField.value+
				"&view="+oSelectView.value;
				
			var myWin = window.open(strURL, 'client_grid_print');
			myWin.focus();
		}
	</script>
</head>
...
<body id="body_bgcolor" marginheight="0" marginwidth="0" topmargin="0" leftmargin="0">
	<table width='100%' height='100%' border="0">
		<tr>
			<td>
				<a href="javascript:addNews();"><img src="../images/page_add.png" border="0" title="add a client"></a>
				<a href="javascript:editNews();"><img src="../images/page_edit.png" border="0" title="edit the selected client details"></a>
				<a href="javascript:delNews();"><img src="../images/page_delete.png" border="0" title="remove the selected client"></a>
			</td>
