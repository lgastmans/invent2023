<?
	...
	/*
		CUSTOM FIELDS
	*/
	$grid_name = 'fsaccounts_list_details';
	$default_alias = 'tr';
...
/*			.ff th.yui-dt-hidden,
		...
		<script language="javascript">
			...
			*/
			...
			var uniqueFilter = "tr.cc_id_from = <?php echo $_GET['id']?>";
			var ID = "transfer_id";
...
/*		var myBody = document.getElementById('myBody');
		...
		myGrid = function() {
			...
			var onCellDblClick = function(oArgs) {
				...
				myWin = window.open("viewaccount.php?action=view&id="+selectedID ,'tax_grid_details','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=650,height=550');
