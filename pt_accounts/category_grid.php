...
/*			.ff th.yui-dt-hidden,
		...
		<script language="javascript">
			/*
				CUSTOM FIELDS
			*/
			var SQL = "SELECT * FROM account_pt_category apc";
			var ID = "category_id";
...
/*		var myBody = document.getElementById('myBody');
		...
		myGrid = function() {
			...
			var onCellDblClick = function(oArgs) {
				...
				myWin = window.open("category_edit.php?action=view&id="+selectedID,'tax_grid_details','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=650,height=550');
