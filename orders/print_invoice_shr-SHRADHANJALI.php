...
/*
	ALTER TABLE `bill_2017_7` ADD `supply_date_time` DATETIME NULL DEFAULT NULL AFTER `salesperson_id`, ADD `supply_place` VARCHAR(75) NOT NULL AFTER `supply_date_time`;
*/
	...
	$supply_date_time = $qry_bill->FieldByName('supply_date_time');
	$supply_place = $qry_bill->FieldByName('supply_place');    
    ...
    $str = "
        ...
        GROUP BY bi.product_id, bi.price, bi.tax_id
        ...
        if ($qry_customer->FieldByName('is_other_state')=='N') {
			...
			$str_items .= 
				"<tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:normal;'>".
					...
					"<td aling='left'>".$qry_items->FieldByName('measurement_unit')."</td>".
					"<td align='right'>".number_format($flt_price, 2, '.', '')."</td>".
					"<td align='right'>".$qry_customer->FieldByName('discount')."%</td>".
					"<td align='right'>".number_format(($flt_discount_price * $total_quantity), 2, '.', ',')."</td>".
					"<td align='right'><table width='100%'><tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:normal;'><td align='right' width='50px'>".number_format($tax_rate, 2, '.', '')."%</td>".
			...
			$str_items .= 
				"<tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:normal;'>".
					...
					"<td align='right'>".$qry_customer->FieldByName('discount')."%</td>".
					"<td align='right'>".number_format(($flt_discount_price * $total_quantity), 2, '.', ',')."</td>".
					"<td align='right'><table width='100%'><tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:normal;'><td align='right'>".number_format($tax_rate, 2, '.', '')."%</td>".
						"<td align='right'>".number_format($tax_amount, 2, '.', '')."</td></tr></table>".
				"</tr>";
		}
...
<table width='100%' border='0'>
<tr>
	<td width='125px' height='42.5px'>
		<img src='../settings/images/Shradhanjali_flower.jpg'>
	</td>
	<td align='center' valign='center'>
		...
		<table>
			<tr>
				<td align="center">
					<font style='font-family:Arial,sans-serif;font-size:14px;font-weight:bold;'>TAX INVOICE</br>
					ANKUR TRUST</br></font></br></br>
				</td>
			</tr>
			<tr>
				<td>
					<table>
						<tr>
							<td>
								<img src='../settings/images/shradhanjali_text.jpg' width="80px">
							</td>
							<td>
								SHRADHANJALI
							</td>
			...
			<tr>
				<td align="center">
					...
					<br>
					Auroshilpam Auroville 605 101 Tamil Nadu<br>
					Tel:(0413) 2622172 Fax:(0413) 2622062<br>
					Email: shradhan@auroville.org.in<br></font>
				</td>
			</tr>
		</table>

	</td>
	<td width='125px' style='font-family:Arial,sans-serif;font-size:12px;font-weight:normal;'>
		<font style='font-size:16px;'>&#9744;</font>  Original Invoice</br>
		<font style='font-size:16px;'>&#9744;</font>  Duplicate Invoice</br>
		<font style='font-size:16px;'>&#9744;</font>  Triplicate Invoice</br>
	</td>
</tr>
</table>
...
<table width='100%' frame="none" cellspacing='0'>
	...
	<tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:normal;'>
		<td align='right' width='200px'>GSTIN:</td>
		<td width='200px'>33AAATA0037B4ZO</td>
	...
	<tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:normal;'>
		...
		<td><?php echo $qry_bill->FieldByName('bill_number'); ?></td>
		<td>Date & Time of Supply:</td>
		<td><?php echo $supply_date_time; ?></td>
	</tr>
	<tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:normal;'>
		<td align='right'>Date:</td>
		<td><?php echo get_date($qry_bill->FieldByName('date_created')); ?></td>
		<td>Place of Supply:</td>
		<td><?php echo $supply_place; ?></td>
	</tr>
...
<table width='100%' frame="none" cellspacing='0'>
	...
	<tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:normal;'>
		...
		<td align='right' width='120px' style='font-weight:bold;'>Name:</td>
		<td width='550px'><?php echo $ship_customer;?></td>
	</tr>

	<tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:normal;'>
		<td align='right' valign="top" style='font-weight:bold;'>Address:</td>
		<td><?php
			 echo $address; 
			 if (!empty($address2))
			 	echo "</br>".$address2;
	...
	<tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:normal;'>
		...
		<td align='right' style='font-weight:bold;'>State:</td>
		<td><?php echo $ship_city.", ".$ship_state;?></td>
	</tr>
	...
	<tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:normal;'>
		...
		<td align='right' style='font-weight:bold;'>State Code:</td>
		<td><?php echo $ship_state_code;?></td>
	</tr>
...
<tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:bold;'>
	...
	<td width='20px' align="left">UoM</td>
	...
	<?php if ($qry_customer->FieldByName('is_other_state')=='Y') { ?>
		<td width='100px'>
			<table width='100%' >
				<tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:bold;'>
					<td width='60px' colspan='2' align='center'>IGST</td></tr>
				<tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:bold;'><td align='right'>Rate</td><td align='right'>Amount</td></tr>
			</table>
		</td>
	<?php } else { ?>
...
<tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:normal;'>
	...
	<td colspan="3">&nbsp;</td>
	<td align="right" style='font-family:Arial,sans-serif;font-size:12px;font-weight:bold;'>
		<?php echo number_format(($flt_total-$tax_total),2); ?>
	</td>
...
<tr style='font-family:Arial,sans-serif;font-size:12px;font-weight:normal;'>
	...
	<td align='right'><?php echo number_format($flt_total, 2, '.', ','); ?></td>
</tr>
...
Bankers: State Bank of India, Auroville. A/C No. 34853163111, IFSC Code: SBIN0003160</br>
ICICI Bank, Auroville. A/C No. 163101000124, IFSC Code: ICIC001631
</font></td>
</tr>
</table>
