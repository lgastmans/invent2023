<?php
    ...
    if (($proforma=='Y') && (IsSet($_GET['order_id']))) {
...
class PDF extends FPDF
{
	...
	function Header()
	{
	    ...
	    // $this->Cell(80);
	    // $this->Cell(30,10,'AUROVILLE FOUNDATION',0,0,'C');
	    // $this->Ln(5);

	    $y = $this->GetY();
	    $pageWidth = $this->GetPageWidth();
	    $x = ($pageWidth/2) - 20;
		$this->Image('../settings/images/Invoice_Header.jpg',$x,$y+10,40);
		$this->Ln($y+2);

		$this->SetFont('Arial','',10);
	    $this->Cell(80);
	    $this->Cell(30,10,'(A Unit of Team Trust)',0,0,'C');
	    //$this->Cell(40);
	    //$this->Cell(80,10,'Original Invoice',0,0,'R');
	    $this->Ln(5);
	    $this->Cell(80);
	    $this->Cell(30,10,'Shakti Auroville 605 101 Tamil Nadu',0,0,'C');
	    $this->Ln(5);
	    $this->Cell(80);
	    $this->Cell(30,10,'Tel:(0413) 2623104, Email: sales@worktree.in',0,0,'C');
	    $this->Ln(5);
    ...
    */
    ...
    for ($i=0; $i<$qry_items->RowCount(); $i++) {
	    ...
	    $pdf->Cell(40,$h,$qry_items->FieldByName('product_description'),1,0,'L');
	    ...
	    $pdf->Cell(15,$h,$qry_customer->FieldByName('discount'),1,0,'C');
    ...
    */
	...
	$pdf->Ln(15);
	$pdf->SetX(162);
	$pdf->Cell(30,5,'for Worktree',0,0,'R');
	$pdf->Ln(5);

	$title = 'Invoice';
	$pdf->SetTitle($title);
	$pdf->SetAuthor('Worktree');
