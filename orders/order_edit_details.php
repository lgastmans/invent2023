...
<form name="order_details" method="GET" onsubmit='return false'>
	...
	<table width="100%" border="0" cellpadding="3" cellspacing="0">
		...
		<tr>
			...
			<td>
				<select name="list_payment_type" onchange="setPaymentType();" onblur='set_session_variables()' class='<?echo $str_class_select?>'>
				<? if ($bool_cash == true) { ?>
				...
				&nbsp;
				<input type="checkbox" <?if ($_SESSION['order_bill_order'] == 'Y') echo "checked";?> name="checkbox_bill" onblur='set_session_variables()' onchange="javascript:setOrderType();" class="<?echo $str_class_header?>">&nbsp;
				<font class="<?echo $str_class_header?>">Make a transfer for this order</font>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input type='text' name='order_note' class='<?echo $str_class_input300?>' value="<?echo $_SESSION['order_note']?>"  onblur='set_session_variables()' onkeypress="focusNext(this, 'account_number', event)" autocomplete="OFF">
			</td>
		</tr>
		...
		<tr valign='center'>
			...
			<td>
				<input type="text" name="account_number" class='<?echo $str_class_input100?>' <?if ($_SESSION['order_bill_type']==BILL_CASH) echo "disabled";?> value="<?echo $_SESSION['order_account_number']?>" onblur='set_session_variables()' onkeypress="focusNext(this, 'list_community', event)" autocomplete="OFF">
				&nbsp;<a href="javascript:openSearch('2')"><img src="../images/findfree.gif" border="0" title="Search" alt="Search" width='23px' height='22px'></a>&nbsp;&nbsp;<span id="account_name" class='<?echo $str_class_header?>'><b><?echo $_SESSION['order_account_name'];?></b></span>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<select name="list_community" onchange="javascript:setOrderType()" onblur='set_session_variables()' class='<?echo $str_class_select?>' <?if ($_SESSION['order_bill_type']==BILL_CASH) echo "disabled";?> onkeypress="focusNext(this, 'list_order_type', event)">
					<?
		...
		<tr>
			...
			<td>
				<select name="list_order_type" onchange="javascript:setOrderType()" onblur='set_session_variables()' onkeypress="focusNext(this, 'list_day', event)">
                                        <? if ($active_daily == 'Y') { ?>
				...
				<select name="list_day" <?if ($_SESSION['order_type']==ORDER_TYPE_DAILY) echo "disabled";?> onblur='set_session_variables()' onchange="javascript:setOrderType()" onkeypress="focusNext(this, 'list_week', event)">
				...
				<select name="list_week" <?if ($_SESSION['order_type']<=ORDER_TYPE_WEEKLY) echo "disabled";?> onblur='set_session_variables()' onchange="javascript:setOrderType()" onkeypress="focusNext(this, 'list_month', event)">
				...
				<select name="list_month" <?if ($_SESSION['order_type']<=ORDER_TYPE_MONTHLY) echo "disabled";?> onblur='set_session_variables()' onchange="javascript:setOrderType()" onkeypress="focusNext(this, 'code', event)">
