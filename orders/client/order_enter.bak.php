...
<head>
	...
	function checkQty(aField) {
		...
		if (can_bill == true) {
			...
			requester_qty.open("GET", "order_quantities.php?live=1&product_code=" + strPassValue + "&qty=" + aField.value);
...
<form name='order_enter' method='GET' onsubmit='return false'>
	<table class="edit" width="100%" height="100%" border="0" cellpadding="2" cellspacing="0">
		...
		<tr>
			...
			<!-- QTY -->
			<td><input type="text" name="qty" value="1" class="input_100" autocomplete="OFF" onkeypress="return focusNext(this, 'code', event)"></td>
