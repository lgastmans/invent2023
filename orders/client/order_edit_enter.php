...
<head>
	...
	function stateHandler() {
		if (requester.readyState == 4) {
			if (requester.status == 200)  {
				...
				oTextBoxPrice = document.getElementById('price');
				...
				if (arr_retval[0] == '__NOT_FOUND') {
					...
					oTextBoxPrice.value = arr_retval[5];
					if (arr_retval[2] == 'Y')
	...
	function focusNext(aField, focusElem, evt) {
		...
		var oTextBoxPrice = document.order_enter.price;
	...
	function clearValues() {
		...
		var oTextBoxQty = document.order_enter.qty;
		var oTextBoxPrice = document.getElementById('price');
	...
	function checkQty(aField) {
		...
		if (can_bill == true) {
			...
			requester_qty.open("GET", "order_edit_quantities.php?live=1&product_code=" + strPassValue + "&qty=" + oTextBoxQty.value + "&price=" + oTextBoxPrice.value);
...
<body bgcolor="lightgrey" leftmargin="2" topmargin="2" marginwidth="2" marginheight="2">
    ...
    <form name='order_enter' method='GET' onsubmit="return false">
		...
		<tr class="normaltext">
			...
			<td>Price<img src="../images/blank.gif" width="35px" height="1px"></td>
			<!--<td>Discount</td>-->
		</tr>
		<tr>
			<!-- CODE -->
			...
			<!-- QTY -->
			<td><input type="text" name="qty" value="1" class="input_100" autocomplete="OFF" onkeypress="return focusNext(this, 'price', event)"></td>

			<!-- MEASUREMENT UNIT -->
			<td align="left"><span id="measurement_unit" class="normaltext">&nbsp;</span></td>

			<td><input type="text" id="price" name="price" value="1" class="input_100" autocomplete="OFF" onkeypress="return focusNext(this, 'code', event)"></td>
