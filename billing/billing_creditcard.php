<?php
	...
	if ($_SESSION['str_user_font_size'] == 'small') {
	    ...
	    $str_class_input_short = "inputbox100_small";
	    $str_class_input = "inputbox300_small";
	    ...
	    $str_class_input_short = "inputbox100";
	    $str_class_input = "inputbox300";
	    ...
	    $str_class_input_short = "inputbox100_large";
	    $str_class_input = "inputbox300_large";
