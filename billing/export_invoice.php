...
//print_r($arr_taxes);
    ...
    */
    ...
    $filename = 'Invoice '.$qry_bill->FieldByName('bill_number').$suffix." - ".$qry_customer->FieldByName('company').".pdf";
...
class PDF extends FPDF
{
	...
	*/
	...
	$pdf->Cell(55,10,'Invoice No.:',0,0,'R');
	$pdf->Cell(20,10,$qry_bill->FieldByName('bill_number').$suffix,0,0,'L');
	$pdf->Cell(40);
