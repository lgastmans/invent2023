<?php
	...
	/*
		CUSTOM FIELDS
	*/
	$grid_name = 'billing_bills_details';
	$default_alias = 'sp';
...
/*			th.yui-dt-hidden,
		...
		<script language="javascript">
			/*
				CUSTOM FIELDS
			*/
			var SQL = "SELECT bi.bill_item_id, bi.quantity, bi.adjusted_quantity, bi.discount, ((bi.quantity %2B bi.adjusted_quantity) * bi.price) AS amount, sp.product_code, sp.product_description, bi.price FROM <?php echo Monthalize('bill_items')?> bi INNER JOIN stock_product sp ON (sp.product_id = bi.product_id) ";
			var ID = "bill_item_id";
			var uniqueFilter = "bi.bill_id = <?php echo $_GET['id']?>";
