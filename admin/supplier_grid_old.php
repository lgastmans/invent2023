	...
	*/
	...
	$arr_fields =
		array (
			...
			3 => array (
				'field' => 'supplier_abbreviation',
				'yui_field' => 'supplier_abbreviation',
				'formatter' => 'string',
				'is_custom_formatter' => 'N',
				'parser' => 'string',
				'filter' => 'Y',
			...
			9 => array (
				'field' => 'is_supplier_delivering',
				'yui_field' => 'is_supplier_delivering',
				'formatter' => 'string',
	...
	<head>
		...
		<script language="javascript">
			/*
				CUSTOM FIELDS
			*/
			var SQL = "SELECT * FROM stock_supplier ss";
			var ID = "supplier_id";
			var canDelete = <? echo ($int_access_level == ACCESS_ADMIN)?>;
			...
			function editRecord() {
				if (selectedID > 0) {
					myWin = window.open("supplier_edit.php?id="+selectedID, 'edit', 'width=800,height=700,resizable=yes');
			...
			function newRecord() {
				myWin = window.open("supplier_edit.php",'insert','toolbar=no,fullscreen=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes,resizable=yes,width=800,height=700,top=0,left=0');
				myWin.moveTo((screen.availWidth/2 - 800/2), (screen.availHeight/2 - 700/2));
				myWin.focus();
			}
	...
	<tr>
		<td><?
			if ($int_access_level > ACCESS_READ) {
				echo "&nbsp;<a href=\"javascript:newRecord();\"><img src=\"../images/page_white_add.png\" border=\"0\" title=\"add a new supplier\"></a>\n";
				echo "&nbsp;<a href=\"javascript:editRecord();\"><img src=\"../images/page_white_edit.png\" border=\"0\" title=\"edit the details of the selected supplier\"></a>\n";
			}
		?>
			&nbsp;
	...
	YAHOO.util.Event.addListener(window, "load", function() {
		myGrid = function() {
						...
						if (canDelete) {
							if (confirm('Are you sure you want to delete this row?')) {
								...
								YAHOO.util.Connect.asyncRequest(
									'GET',
									'supplierdelete.php?action=delete' + myBuildUrl(this,record),
									{
										success: function (o) {
			...
			var onCellDblClick = function(oArgs) {
				...
				myWin = window.open("tax_grid_details.php?action=view"+ myBuildUrl(this,record),'tax_grid_details','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=650,height=550');
