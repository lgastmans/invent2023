...
/*
$Id: nusoap.php,v 1.2 2006/02/15 06:56:17 cvs Exp $
...
* @version  $Id: nusoap.php,v 1.2 2006/02/15 06:56:17 cvs Exp $
* @access   public
*/
class nusoap_base {
...
* $soapclientw = new soapclient( string path [ ,boolean wsdl] );
*
