...
/*			.ff th.yui-dt-hidden,
		...
		<script language="javascript">
			...
			*/
			...
			function editRecord() {
				if (selectedID > 0) {
					myWin = window.open("supplier_edit.php?id="+selectedID, 'edit', 'width=800,height=700,resizable=yes,scrollbars=yes');
...
/*		var myBody = document.getElementById('myBody');
		...
		myGrid = function() {
			...
			var onCellDblClick = function(oArgs) {
				...
				myWin = window.open("supplier_edit.php?id="+selectedID,'supplier_edit','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=800,height=700');
				myWin.moveTo((screen.availWidth/2 - 800/2), (screen.availHeight/2 - 700/2));
				myWin.focus();
			}
