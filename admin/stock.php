...
$grid->addColumn("Barcode", "product_bar_code", "string", true, 150);
...
$grid->addColumn("Image", "image_filename", "string", true, 100);
$grid->loadView();
...
function newRecord() {
  myWin = window.open("product_edit.php",'stock','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=1000,height=620,top=0');
...
function openRecord() {
  myWin = window.open("product_edit.php?id="+intSerialNumber,'stock','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,width=1000,height=620,top=0');
  myWin.moveTo((screen.availWidth/2 - 1000/2), (screen.availHeight/2 - 620/2));
  myWin.focus();
//  return false;
}
